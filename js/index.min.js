...
function _toConsumableArray(a){if(Array.isArray(a)){
    ...
    var playing=!0,timer=function(){
        ...
        var interval=timer()
        var minus=document.getElementById("minus"),plus=document.getElementById("plus"),heart=document.getElementById("heart"),pause=document.getElementById("pause"),commentForm=document.getElementsByTagName("form")[0];
